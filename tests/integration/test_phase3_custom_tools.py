...
from custom_components.pepa_arm_ha.tools.custom import RestCustomTool, ServiceCustomTool
...
async def test_tool_timeout_fires_proper_events(mock_hass_for_custom_tools, session_manager):
    ...
    """
    from custom_components.pepa_arm_ha.const import EVENT_TOOL_PROGRESS
    from custom_components.pepa_arm_ha.exceptions import ToolExecutionError
    from custom_components.pepa_arm_ha.tool_handler import ToolHandler
