...
class TestOptionsFlowReconfiguration:
    ...
    async def test_llm_settings_reconfiguration(
        ...
        with patch("custom_components.pepa_arm_ha.agent.HomeAgent") as mock_agent_class:
            ...
            with patch(
                "custom_components.pepa_arm_ha.ConversationSessionManager"
    ...
    async def test_memory_preserved_across_reload(
        ...
        with patch("custom_components.pepa_arm_ha.agent.HomeAgent") as mock_agent_class:
            ...
            with patch(
                ...
                with patch("custom_components.pepa_arm_ha.memory_manager.MemoryManager"):
                    # Initial setup
                    result = await async_setup_entry(test_hass, mock_config_entry)
                    assert result is True
