...
from custom_components.pepa_arm_ha.conversation import ConversationHistoryManager
...
class TestConversationPersistence:
    ...
    async def test_save_to_storage_fires_event(self):
        ...
        from custom_components.pepa_arm_ha.const import EVENT_HISTORY_SAVED
    ...
    def test_setup_scheduled_cleanup(self):
        ...
        with patch(
            "custom_components.pepa_arm_ha.conversation.async_track_time_interval"
        ) as mock_track:
            manager = ConversationHistoryManager(max_messages=10, hass=mock_hass, persist=True)
